defmodule JobProcessorWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json, :sh],
        layouts: [html: JobProcessorWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {JobProcessorWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import JobProcessorWeb.CoreComponents
      import JobProcessorWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: JobProcessorWeb.static_paths()
    end
  end
