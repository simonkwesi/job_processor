defmodule JobProcessorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JobProcessorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JobProcessorWeb.Gettext, "errors", msg, opts)
    end
  end
